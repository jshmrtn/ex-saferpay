defmodule ExSaferpay.Transaction do
  ...
  ExSaferpay.defrequest initialize(transaction_initialize),
  ...
  ExSaferpay.defrequest authorize_direct(transaction_authorize_direct),
  ...
  ExSaferpay.defrequest capture(transaction_capture),
  ...
  ExSaferpay.defrequest authorize(transaction_authorize),
